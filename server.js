...
app.post('/api/chat', async (req, res) => {
    try {
        ...
        // THE NUCLEAR AFFIRMATIVE OVERRIDE INJECTION
        // This explicitly blocks the 8B model from inventing meetings or calendar events.
        const enforcedMessage = `[SYSTEM OVERRIDE ENFORCEMENT: 
1. Keep voice response to MAX 2 sentences. 
2. If asked about schedules, calendars, meetings, or resumes, YOU MUST REPLY EXACTLY WITH: "I am a cloud entity, Boss. I do not have access to your local calendar or local system files." Do not add anything else.
