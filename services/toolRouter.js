...
const REGISTRY_METADATA = [
    ...
    { name: 'github_repos', description: 'Fetch authenticated GitHub user repositories', tags: ['github', 'repos', 'github_repos', 'git'], triggers: ['github', 'repos', 'my repos'] },
    { name: 'github_analyze', description: 'Analyze GitHub repository code', tags: ['github', 'analyze'], triggers: ['analyze github'] },
    { name: 'github_push', description: 'Push code changes to GitHub repository', tags: ['github', 'push'], triggers: ['push github'] },
    { name: 'stock_quote', description: 'Look up live stock prices and financial quotes', tags: ['stock', 'aapl', 'quote', 'price', 'market'], triggers: ['stock', 'quote', 'aapl'] },
    { name: 'notion_search', description: 'Search Notion workspace pages', tags: ['notion', 'search'], triggers: ['search notion'] },
    { name: 'notion_create', description: 'Create a new Notion page', tags: ['notion', 'create'], triggers: ['create notion'] },
...
export async function routeCapabilityToTools(requiredCapability, stepDescription, catalog) {
    ...
    const capToTags = {
        ...
        github: ['github_repos', 'github_analyze', 'github_push', 'github', 'repos'],
        stock: ['stock_quote', 'stock', 'quote', 'aapl', 'price'],
