...
// @internal — used by initializer.ts's bundled-skills fallback path
// (alpha.10, codex review #1). Surfaced here for advanced consumers
// who want to generate SKILL.md without the full initializer flow.
// Not covered by semver; may move under a sub-export in a future major.
export { generateBuiltInSkill } from './generators/skill-md.js';
// Re-export config generator helpers.
// @internal — same caveat as generateBuiltInSkill. Used by the init
// flow to emit project-local .agents/config.toml.
