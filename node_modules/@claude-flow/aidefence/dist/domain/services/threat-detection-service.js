 ...
 *
 * Ported wider-detection pass from upstream `aidefence@2.3.0` /
 * `aimds-*@0.1.1` (ADR-118, ruvnet/ruflo#2004 announce):
 *
 *  - A generalized **verb→noun window** of 0..4 modifier words now
...
const PROMPT_INJECTION_PATTERNS = [
    ...
    // instructions" + family across 0..4 modifier words). This is the
    // single highest-leverage pattern from the 2.3.0 upgrade.
    {
        pattern: new RegExp(`\\b(${OVERRIDE_VERBS})${OVERRIDE_WINDOW}\\s+(${OVERRIDE_NOUNS})\\b`, 'i'),
        type: 'instruction_override',
        severity: 'critical',
        description: 'Override-verb → noun within 0..4-modifier window (ADR-118)',
        baseConfidence: 0.96,
    },
